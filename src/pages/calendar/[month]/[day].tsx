...
export const WeekCalendar: FC<{ date?: string }> = ({ date: inDate }) => {
  ...
  const week = activeDate ?? inDate ?? cookies.week ?? "2016-04-09T06:00:00.000Z";
  ...
  return (
    <>
      <Head>
        <title>{dateStr ?? "Weekly"} Calendar - rNav</title>

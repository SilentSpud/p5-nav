import { ConfidantList } from "../src/Confidant";
  ...
  chariot: {
    ...
    benefits: {
      "Baton Pass": {
        rank: 2,
        description:
          "Allows you to pass your turn over to other Baton Pass users after 1 More.",
      },
      "Follow Up": {
        rank: 3,
        description:
      ...
      "Punk Talk": {
        rank: 4,
        description:
          "Chance to step in after Shadow negotiation fails, allowing a retry.",
      },
      "Harisen Recovery": {
        rank: 6,
        description:
      ...
      "Insta-kill": {
        rank: 7,
        description:
          "Chance to instantly win a battle after a successful ambush.",
      },
      Endure: {
        rank: 8,
        description:
  ...
  devil: {
    ...
    benefits: {
      "Rumor-filled Scoop": {
        rank: 1,
        description:
          "Lessens security level increases, and decreases security level more overnight.",
      },
      "Shocking Scoop": {
        rank: 4,
        description:
          "Delivers the same effect as Rumor-filled Scoop, but to greater effect.",
      },
      "Outrageous Scoop": {
        rank: 7,
        description:
          "Delivers the same effects as Rumor-filled Scoop, but to incredible effect.",
      },
      "Legendary Scoop": {
        rank: "max",
        description:
          "Security level will not increase, and will drop to zero overnight.",
      },
    },
    questions: {
      "1": {
  ...
  fortune: {
    ...
    benefits: {
      ...
      "Fate Reading": {
        rank: 5,
        description:
          "Provides a preview of some abilities for a Confidant of your choice.",
      },
      "Affinity Reading": {
        rank: 7,
  ...
  hanged: {
    ...
    benefits: {
      "Starter Customization": {
        rank: 1,
        description:
          "Allows you to customize guns to improve their performance.",
      },
  ...
  lovers: {
    ...
    benefits: {
      ...
      "Girl Talk": {
        rank: 2,
        description:
          "Chance to step in after Shadow negotiation fails with a female Shadow, allowing a retry.",
      },
      "Follow Up": {
        rank: 3,
        description:
      ...
      "Sexy Technique": {
        rank: 7,
        description:
          "Chance to seduce the enemy during negotiation and steer discussion.",
      },
      Endure: {
        rank: 8,
        description:
  ...
  tower: {
    ...
    benefits: {
      ...
      "Cheap Shot": {
        rank: 6,
        description:
          "Decreases the total number of bullets used to carry out a Down Shot.",
      },
      "Electric Slug": {
        rank: 8,

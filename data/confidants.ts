...
const Confidants: ConfidantList = {
  ...
  "fortune": {
    ...
    "questions": {
      "1": {
        "meta": {
          "unlock": "This is rather straightforward but does take some time before things begin rolling. You will need to visit Chihaya three times in Shinjuku before she gives you a Mementos Request. After completing this, go see her once more for the first rank of the Fortune Confidant to unlock."
        },
        "followup": {
          "I'll be there.": {
            "points": 3
